        ...
        <form className="bg-gray-50 p-8 md:p-12 rounded-3xl border border-gray-200 shadow-xl">
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            <div className="space-y-2">
              <label className="text-xs font-bold text-gray-700 uppercase">Su Nombre</label>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-gray-700 uppercase">¿Qué está buscando?</label>
              <div className="relative">
                <select className="w-full bg-white border border-gray-300 p-4 rounded-xl focus:border-black focus:ring-0 outline-none transition appearance-none">
                  ...
                  <option>Producción Masiva (Eventos/Gorras)</option>
          ...
          <div className="mb-8 space-y-2">
            <label className="text-xs font-bold text-gray-700 uppercase">Detalles del Pedido</label>
            <textarea rows="3" className="w-full bg-white border border-gray-300 p-4 rounded-xl focus:border-black focus:ring-0 outline-none transition" placeholder="Cantidades aproximadas, fechas de entrega, tipo de tela..."></textarea>
          </div>
          ...
          <p className="text-center text-xs text-gray-400 mt-4">
            Sus datos son tratados confidencialmente para fines comerciales.
          </p>
        </form>
      </div>
    </section>
